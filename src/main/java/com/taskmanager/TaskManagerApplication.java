...
//				User admin2 = new User("admin2", "admin@example.com", passwordEncoder.encode("111"));
//				admin2.getRoles().add(adminRole);
//				userRepository.save(admin2);
//				User admin3 = new User("admin3", "admin@example.com", passwordEncoder.encode("111"));
//				admin3.getRoles().add(adminRole);
//				userRepository.save(admin3);

				// Manager
				User manager = new User("manager", "manager@example.com", passwordEncoder.encode("111"));
				manager.getRoles().add(managerRole);
				userRepository.save(manager);
//				User manager2 = new User("manager2", "manager@example.com", passwordEncoder.encode("111"));
//				manager2.getRoles().add(managerRole);
//				userRepository.save(manager2);
//				User manager3 = new User("manager3", "manager@example.com", passwordEncoder.encode("111"));
//				manager3.getRoles().add(managerRole);
//				userRepository.save(manager3);

				// IT User
				User ituser = new User("ituser", "ituser@example.com", passwordEncoder.encode("111"));
				ituser.getRoles().add(itRole);
				userRepository.save(ituser);
//				User ituser2 = new User("ituser2", "ituser@example.com", passwordEncoder.encode("111"));
//				ituser2.getRoles().add(itRole);
//				userRepository.save(ituser2);
//				User ituser3 = new User("ituser3", "ituser@example.com", passwordEncoder.encode("111"));
